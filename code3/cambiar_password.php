...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($passwordActual) || empty($passwordNueva) || empty($passwordConfirm)) {
        ...
        $usuario = autenticarUsuario($pdo, $dni, $passwordActual);
        ...
        if (!$usuario) {
            ...
            // Paso el objeto $pdo a la función.
            if (cambiarPassword($pdo, $dni, $passwordNueva)) {
                $mensaje = 'Contraseña cambiada correctamente.';
            } else {
                $error = 'Error al cambiar la contraseña. Inténtelo de nuevo.';
            }
        }
    }
}
            ...
            <section class="seccion-datos">
                ...
                <form method="POST" action="">
                    ...
                    <div class="campo-formulario">
                        ...
                        <input type="password" id="password_nueva" name="password_nueva" minlength="6" required>
